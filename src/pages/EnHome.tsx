    ...
    <div className="flex flex-col gap-16 py-8 max-w-5xl mx-auto px-4">
      ...
      <section>
        ...
        <div className="grid grid-cols-2 md:grid-cols-5 gap-4">
          <Link to="/en/category/exchange-rate" className="p-6 bg-white border border-gray-200 rounded-2xl hover:border-blue-500 hover:shadow-md transition-all group text-center">
          ...
          <Link to="/en/category/dollar" className="p-6 bg-white border border-gray-200 rounded-2xl hover:border-blue-500 hover:shadow-md transition-all group text-center">
            ...
            <h3 className="font-bold text-gray-900 mb-1">Dollar</h3>
          </Link>
          <Link to="/en/category/interest-rate" className="p-6 bg-white border border-gray-200 rounded-2xl hover:border-blue-500 hover:shadow-md transition-all group text-center">
            ...
            <h3 className="font-bold text-gray-900 mb-1">Interest Rate</h3>
          </Link>
          <Link to="/en/category/etf" className="p-6 bg-white border border-gray-200 rounded-2xl hover:border-blue-500 hover:shadow-md transition-all group text-center">
          ...
          <Link to="/en/category/economy-basics" className="p-6 bg-white border border-gray-200 rounded-2xl hover:border-blue-500 hover:shadow-md transition-all group text-center">
