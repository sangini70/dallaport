    ...
    <div className="flex flex-col gap-16 py-8 max-w-5xl mx-auto px-4">
      ...
      <section>
        ...
        <div className="grid grid-cols-2 md:grid-cols-5 gap-4">
          <Link to="/en/search?q=Exchange Rate" className="p-6 bg-white border border-gray-200 rounded-2xl hover:border-blue-500 hover:shadow-md transition-all group text-center">
          ...
          <Link to="/en/search?q=Dollar" className="p-6 bg-white border border-gray-200 rounded-2xl hover:border-blue-500 hover:shadow-md transition-all group text-center">
          ...
          <Link to="/en/search?q=Interest Rate" className="p-6 bg-white border border-gray-200 rounded-2xl hover:border-blue-500 hover:shadow-md transition-all group text-center">
          ...
          <Link to="/en/search?q=ETF" className="p-6 bg-white border border-gray-200 rounded-2xl hover:border-blue-500 hover:shadow-md transition-all group text-center">
          ...
          <Link to="/en/search?q=Economy Basics" className="p-6 bg-white border border-gray-200 rounded-2xl hover:border-blue-500 hover:shadow-md transition-all group text-center">
