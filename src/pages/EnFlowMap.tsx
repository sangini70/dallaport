...
export default function EnFlowMap() {
  ...
  return (
    <div className="py-8 max-w-5xl mx-auto px-4">
      <Helmet>
        <title>Flow Map | dallaport</title>
        <meta name="description" content="Check out the entire learning flow map of dallaport." />
      </Helmet>

      <div className="mb-8">
        <div className="text-blue-600 text-xs font-bold tracking-widest mb-2 uppercase">Flow Map</div>
        <h1 className="text-3xl font-extrabold text-gray-900">Learning Flow Map</h1>
      </div>
      
      <div className="bg-white p-8 rounded-3xl border border-gray-200 shadow-sm">
        <p className="text-gray-600 mb-8 leading-relaxed">
          dallaport's content is most effective when learned sequentially. Follow the flow map below to complete your financial knowledge.
        </p>
